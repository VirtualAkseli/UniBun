...
public class huffmanTree {
    ...
    frequencyCalculator freq1 = new frequencyCalculator();
    Leaf tempLeaf;
    Leaf root;
    ...
    public String getCompString() {
        ...
        for (int l = 0; l < s3.length(); l++) {
            Character c3 = s3.charAt(l);

            s5 = c3.toString();

            s4 = s4 + (this.symbolsInBinary.get(s5));
        }
        return s4;
    }

    public String decodeTree() {
        System.out.println(tempHeap2.size());
